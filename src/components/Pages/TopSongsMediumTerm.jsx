...
const TopSongsMediumTerm = () => {
  ...
  const handleGetTopSongs = () => {
    axios
      .get(`${TOPSONGS_ENDPOINT}?${MEDIUM_TERM}&limit=50&offset=0`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  return (
    <div>
      <h1>Top Tracks of {user.display_name} (Last 6 months)</h1>
...
export default TopSongsMediumTerm;
